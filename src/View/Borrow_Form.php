...
/**
 * Handles borrowing form submission and displays borrow UI.
 *
 * This script processes user input for borrowing books,
 * validates request flow, calls BorrowRepository, and
