...
/**
 * Displays the list of books from the library system.
 *
 * This script retrieves all books from the BookRepository and renders
 * them in an HTML table format for the user interface.
 *
 * @author Charlo Marco
 * @since 2026-05-08
 */
